...
import type { MenuItemDefinition, User } from "../navigation.types";
			...
			<Trigger className="relative flex cursor-pointer flex-col items-start gap-1 outline-hidden">
				...
				<div className="flex items-center gap-2">
					<div className="relative size-12">
						{avatarUrl ? (
							// biome-ignore lint/performance/noImgElement: Dynamic Avatar from Discord
						...
						<div className="absolute right-0 bottom-0 size-3 rounded-full border-2 border-white bg-[green]" />
					</div>
