...
export const Parallax: FC = () => (
	<div className="relative h-screen overflow-hidden">
		<div className="fixed inset-0 -z-50 flex items-center justify-center">
			<div
				role="presentation"
				className="inset-0 flex items-center justify-center font-black text-[42vw] text-brand-800 uppercase"
			>
				Yes
			</div>
		</div>

		<div className="absolute -inset-x-3/4 top-1/3 bottom-0 -z-40">
